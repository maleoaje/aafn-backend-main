...
>
  ...
  <head>
    <title>All American Foods Network</title>
    <!--[if !mso]><!-->
    ...
    <div style="background-color:#f2f3f8; padding-bottom:100px;">
                                    ...
                                    <tbody>
                                      <tr>
                                        <td style="width:150px;">
                                          <!-- All American Foods Network Logo -->
                                          <img
                                            alt="All American Foods Network Logo"
                                            height="auto"
                                            src="${option.company_logo || "http://localhost:5055/static/logo/logo-all-american-food-network.png"}"
      ...
      >
                    ...
                    <tbody>
                      <tr>
                        ...
                        >
                          ...
                          >
                            <!--start email_template -->
                            <h2 style="color:#2d2651;">Hello ${option.name}</h2>
                            <p>Verify your email address to complete the signup and login into your <strong>All American Foods Network</strong> account.
                            </p>
        ...
        <p style="margin-bottom:20px;">Click this link for active your account</p></p>
                             ...
                             <a href=${process.env.STORE_URL}/auth/email-verification/${option.token} style="background:#2d2651;color:white;border:1px solid #2d2651; padding: 10px 15px; border-radius: 4px; text-decoration:none;">Verify Account</a>

                            <p style="margin-top: 35px;">If you did not initiate
                              this request, please contact us immediately at
                              support@allamericanfoodsnetwork.com</p>

                            <p
                              style="margin:0px auto; margin-top:40px; text-align:center;"
                            >Thank you
                              <h4
                                style="margin:1px; margin-bottom:0px; text-align:center; color:#2d2651;"
                              >All American Foods Network Team</h4></p>
                                                  ...
                                                  <tr>
                                                    ...
                                                    >
                                                      ...
                                                      >
                                                        ...
                                                        email because you
                                                        registered with All American Foods Network
                                                        and agreed to receive
                                                        emails from us regarding
                                                        new features, events and
                                                        special offers.
                                                        <p
                                                          style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:11px;font-weight:400;line-height:16px;text-align:center;color:#2d2651;"
                                                        >
                                                          &copy; All American Foods Network, All
