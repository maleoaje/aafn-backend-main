...
const generateHeader = async (doc, invoice) => {
  ...
  // Add All American Foods Network logo
  try {
    const logoPath = path.join(__dirname, "../../public/logo/logo-all-american-food-network.png");
    doc.image(logoPath, doc.page.width - 90, doc.y - 75, {
      width: 40,
    });
  } catch (err) {
